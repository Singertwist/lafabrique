...
def articles_plats(request, slug, ordre):
	...
	return render(request, "commander.html", {'sous_categories_articles':sous_categories_articles, 'categories_articles':categories_articles})
...
def articles_plats_composer(request, id, slug):
	...
	return render(request, "commander-suite-composer.html",{'sous_categories_articles':sous_categories_articles, 'type_produit':type_produit, 'articles':articles})
...
def articles_plats_pret(request, id, slug):
	...
	return render(request, "commander-suite-pret.html", {'sous_categories_articles':sous_categories_articles, 'articles':articles})