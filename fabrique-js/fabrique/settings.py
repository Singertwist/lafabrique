...
SECRET_KEY = '1j@s0e2mg#50!d#1e-*rp#z$!i^s98++q(ugu7o!6w#s=q%t7!'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'fabrique.context_processors.menu_commander',
                'fabrique.context_processors.menu_producteurs',
                'fabrique.context_processors.panier',
            ],
        },
    },
]
...
# Durée de stockage du cookies (en secondes :  100 ans) ==> 60 secondes * 60 minutes * 24 heures * 365 jours * 100 ans
